...
## Proven
Measured on a **discriminating** probe corpus of **23 cases (10 flagged + 13 safe)** — verified by
...
These numbers hold **on the published probe set (N=23)**. A probe set is a floor, not a
